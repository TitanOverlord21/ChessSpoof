...
const Pieces = [
  ...
  new Bishop("White", "A3", "WhiteBishop.png"),
  new Queen("White", "A4", "WhiteQueen.png"),
  new King("White", "A5", "WhiteKing.png"),
  new Bishop("White", "A6", "WhiteBishop.png"),
  new Knight("White", "A7", "WhiteKnight.png"),
  new Rook("White", "A8", "WhiteRook.png"),
  ...COLS.map((col) => new Pawn("White", `B${col}`, "WhitePawn.png")),
  new Rook("Black", "H1", "BlackRook.png"),
  new Knight("Black", "H2", "BlackKnight.png"),
  new Bishop("Black", "H3", "BlackBishop.png"),
  new Queen("Black", "H4", "BlackQueen.png"),
  new King("Black", "H5", "BlackKing.png"),
  new Bishop("Black", "H6", "BlackBishop.png"),
